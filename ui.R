...
#Title style and content, using html tags
  div(style="height: 80px;  ", 
    tags$a(
      ...
      href= "http://www.scotpho.org", target="_blank" #hyperlink, opens new window/tab
    ),
    h3("ScotPHO Profiles", 
...
tabPanel("Trend", icon = icon("area-chart"),
         beta_box,  
         p(tags$b("Explore changes over time. ")),
         tags$ul( 
...
tabPanel("Rank", icon = icon("signal"),
         beta_box,  
         p(tags$b(" Compare geographical areas. ")),
         tags$ul( 
         ...
         wellPanel( 
           column(6,
                  ...
                  img(src='legend_rank.png', height = 130), 
                  fluidRow(
                    downloadButton('download_rank', 'Download data', class = "down"))  #For downloading the data
           ),  
           column(6,
...
tabPanel("Table", icon = icon("table"),
         ...
         div(DT::dataTableOutput("table_opt"), style = "font-size:70%")
                ),
###############################################.             
##############Help----    
###############################################.
