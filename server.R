...
function(input, output, session) {
  ...
  observeEvent(input$help_trend, {
    ...
    showModal(modalDialog(
      ...
      p(column(7,
               tags$a(img(src="help_trend_chart2.png"))),
        column(5,
  ...
  rank_help_main_modal <- modalDialog(
    ...
    p("In 'step 4' the comparator can be changed to 'Time', this changes the chart shown and adds an extra dimension to the area comparison."),
  ...
  rank_byarea_modal <- modalDialog(
    ...
    p("The comparator area can be changed using the 'Step 4b' drop-down menu."),
