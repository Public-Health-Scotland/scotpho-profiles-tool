...
#list of options to change which metric is displayed in inequalities module
depr_measure_options <- c("Patterns of inequality", "Inequality gap", "Potential for improvement","About these options")
