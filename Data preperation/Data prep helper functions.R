  ...
  data <- data %>% 
    ...
    assert_that(nrow(data) == 0, 
                msg = paste0("The same indicator ID was found in more than 1 data file.", 
                             paste0(rep(emo::ji("-1"), 10), collapse = ""), 
                             paste0(rep(emo::ji("triangular_flag_on_post"), 10), collapse = ""), 
                             paste0(rep(emo::ji("x"), 10), collapse = ""),
...
TEST_no_missing_indicators <- function(data) {
  ...
  data <- anti_join(technical_doc, data, by = c("ind_id"))
    ...
    assert_that(nrow(data) == 0, 
                msg = paste0(paste0(rep(emo::ji("-1"), 10), collapse = ""), 
                             paste0(rep(emo::ji("triangular_flag_on_post"), 10), collapse = ""), 
                             paste0(rep(emo::ji("x"), 10), collapse = ""),
  ...
  data <- data %>%
    ...
    assert_that(nrow(data) == 0, 
                msg = paste0(paste0(rep(emo::ji("-1"), 10), collapse = ""), 
                       paste0(rep(emo::ji("triangular_flag_on_post"), 10), collapse = ""), 
                       paste0(rep(emo::ji("x"), 10), collapse = ""),
                       "SUPPRESSION NOT APPLIED! Please run the suppression function before saving this data.\n",
