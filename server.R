...
function(input, output, session) {
  ...
  ####vicky addition to make stand alone modal window for indicator updates----
  #Set up "See latest updates" Modal window
  ...
  observeEvent(input$btn_indicator_updates, { showModal(updates_modal2) }) # Link action button click to modal launch 
